...
export interface Page {
  ...
  title: string;
  /**
   * When enabled, only logged-in users can access this page
   */
...
export interface Skill {
  id: string;
  name: string;
  category: 'Frontend' | 'Backend' | 'Cloud' | 'Commerce' | 'Architecture' | 'Productivity';
  proficiency: number;
  description?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface Testimonial {
   ...
   */
  relationship?: ('client' | 'colleague' | 'manager' | 'team-member' | 'other') | null;
  /**
...
export interface Certification {
  ...
  /**
   * Logo of the issuing organization
   */
  ...
  description?: string | null;
  /**
   * Key skills or technologies covered by this certification
   */
  skills?:
    | {
        skill: string;
    ...
    | null;
  /**
   * Display this certification prominently
   */
  featured?: boolean | null;
  updatedAt: string;
  createdAt: string;
...
export interface SiteSetting {
  id: string;
  /**
   * Upload your profile picture for the hero section
   */
  ...
  heroButtons?:
    | {
        label: string;
        /**
         * Use #section-id for anchor links or full URL for external links
         */
        link: string;
  ...
  alternativeContactText?: string | null;
  ...
  /**
   * Default page title for the homepage
   */
